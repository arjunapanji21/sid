...
<body>
    <section class="bg-primary-700 dark:bg-primary-900 min-h-screen flex justify-center items-center">
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    <form class="space-y-4 md:space-y-6" action="{{route('auth')}}" method="post">
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Belum punya akun? <a href="{{route('registrasi')}}" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Daftar!</a>
                        </p>
                    </form>
                </div>
            </div>
